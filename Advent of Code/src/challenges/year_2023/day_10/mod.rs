...
fn part2(input: &str) -> String {
    ...
    // then we will just flood fill the area outside of the loop
    // and then finally from full area of grid subtract area of loop pipes and flood filled area to get inside area
